...
const resources = [
  {
    title: 'NAB',
    subtitle:
      'Andrew Thorburn is a worse CEO than Mr Burns.',
  ...
  },
  {
    ...
    subtitle:
      'Clearly the biggest bank and not JUST a hanger-on of Westpac',
  ...
  },
  {
    title: 'ANZ',
    subtitle:
      'Amazon are going to acquire these guys and rename them to A2Z',
      ...
      <div className="animate-in flex flex-col gap-14 opacity-0 max-w-4xl px-3 py-16 lg:py-24 text-foreground">
        ...
        <div className="flex flex-col gap-8 text-foreground">
          <h2 className="text-lg font-bold text-center">
            We provide support for these banks out of the box
          </h2>
